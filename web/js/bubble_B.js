(function() {
  ...
  sketch.mouse.x = sketch.width / 4;

  sketch.mouse.y = sketch.height / 4;

  sketch.strokeStyle = 'hsla(10, 50%, 50%, .4)';
  ...
  Particle.prototype = {
    ...
    render: function() {
      ...
      sketch.closePath();
      sketch.fillStyle = 'hsla(' + this.hue + ', 100%, 90%, .10)';
      sketch.fill();
